...
public class Selenium {
    public static void main(String[] args) {
        ...
        driver.findElement(loginUserNameInputLocator).sendKeys("yusufcit@gmail.com"); // step 4
        driver.findElement(loginPasswordInputLocator).sendKeys("bangladesh"); // step 5
